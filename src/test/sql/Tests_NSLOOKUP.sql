...
CREATE OR REPLACE PROCEDURE TEST_NSLOOKUP_LOCALHOST()
 BEGIN
...
-- Test to retrieve the name of the local machine.
CREATE OR REPLACE PROCEDURE TEST_NSLOOKUP_GOOGLE()
 BEGIN
  DECLARE EXPECTED VARCHAR(15);
  DECLARE ACTUAL VARCHAR(15);
  DECLARE IP VARCHAR(255);
...
CREATE OR REPLACE PROCEDURE TEST_REVERSE_YAHOO()
 BEGIN
  DECLARE EXPECTED VARCHAR(15);
  DECLARE ACTUAL VARCHAR(15);
...
-- Test the function with a null ip.
